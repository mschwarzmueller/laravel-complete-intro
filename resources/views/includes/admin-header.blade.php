<header class="top-nav">
    <nav>
        <ul>
            ...
            <li {{ Request::is('admin/contact/*') ? 'class=active' : '' }}><a href="{{ route('admin.messages.index') }}">Contact Messages</a></li>
            <li {{ Request::is('admin/logout') ? 'class=active' : '' }}><a href="#">Logout</a></li>
        </ul>
    </nav>
</header>